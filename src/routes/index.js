...
const EntityView = loadable(() => import(/* webpackChunkName: 'entity' */ '@/views/Graph/Entity'))
const GroupView = loadable(() => import(/* webpackChunkName: 'group' */ '@/views/Graph/Group'))
...
const routes = [
    ...
    { path: '/graph/entity', exact: true, name: '实体', component: EntityView, auth: [1] },
    { path: '/graph/group', exact: true, name: '三元组', component: Index, auth: [1] }
    // { path: '/index', exact: true, name: 'Index', component: Index, auth: [1] },
